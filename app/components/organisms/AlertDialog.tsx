...
const AlertDialog: FC<AlertDialogProps> = ({ children, onClick, title, description }) => {
  return (
    <AlertDialogR.Root>
      <AlertDialogR.Trigger className="bg-red-600 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none  outline-none">
        {children}
      ...
      <AlertDialogR.Content className="fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
        ...
        <div className="flex justify-end gap-[25px]">
          <AlertDialogR.Cancel className="text-slate-600 bg-slate-400 hover:bg-slate-700  inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]">
            Cancel
          </AlertDialogR.Cancel>
          <AlertDialogR.Action
            onClick={onClick}
            className="text-red-300 bg-red-500 hover:bg-red5 focus:shadow-red7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
          >
            Yes, delete account
          </AlertDialogR.Action>
        </div>
